...
import GroupActivityChart from "./subQuestionDisscusstion/GroupActivityChart";
import StudentsWithoutComments from "./subQuestionDisscusstion/StudentsWithoutComments";
...
function QuestionDiscussion() {
  ...
  const [showStudentsWithoutComments, setShowStudentsWithoutComments] =
    useState(false);
  ...
  const handleTabChange = (tab) => {
    ...
    if (tab === "GROUP") {
      ...
      dispatch(fetchGradesForQuestion(questionId));
    }
  };
    ...
    <div className="flex h-full bg-gray-100">
            ...
            {activeTab === "GRADE" && (
              <div className="p-4">
                {currentGrades && currentGrades.length > 0 ? (
                  <GradeDisplay grades={currentGrades} />
                ) : (
      ...
      <div className="w-64 bg-white p-4 border-l">
        ...
        <div className="space-y-2 mb-5">
          ...
          <button
            className="w-full text-center rounded h-10 leading-10 bg-blue-500"
          ...
          {showLinkModal && (
            <UpdateLinkModal
              ...
              currentLink={currentSlot.linkDrive}
            />
          )}
        </div>
        <div className="space-y-2 mb-5">
        ...
        <div className="space-y-2 mb-5">
          ...
          <div className=" flex">
            <img
              ...
              onClick={() => setShowGroupActivity(true)}
            />
            ...
            <img
              ...
              onClick={() => setShowStudentsWithoutComments(true)}
            />
          </div>
          {showGroupActivity && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
              <div className="bg-white p-4 rounded-lg">
                <GroupActivityChart groups={currentGroup} comments={comments} />
                <button
                  onClick={() => setShowGroupActivity(false)}
          ...
          {showStudentActivity && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
              <div className="bg-white p-4 rounded-lg">
                ...
                />
                <button
                  onClick={() => setShowStudentActivity(false)}
                  className="mt-4 px-4 py-2 bg-blue-500 text-white rounded"
                >
                  Close
                </button>
          ...
          {showStudentsWithoutComments && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
              <div className="bg-white p-4 rounded-lg">
                ...
                />
                <button
                  onClick={() => setShowStudentsWithoutComments(false)}
                  className="mt-4 px-4 py-2 bg-blue-500 text-white rounded"
                >
                  Close
                </button>
